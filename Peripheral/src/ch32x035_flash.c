...
FLASH_Status FLASH_EnableWriteProtection (uint32_t FLASH_Pages) {
    ...
    if ((FLASH->OBR & RDPRT_Mask) != (uint32_t)RESET) {
        ...
        if (status == FLASH_COMPLETE) {
            ...
            buf[2] = ((uint32_t)(((uint32_t)(WRP0_Data)&0x00FF) + (((uint32_t)(~WRP0_Data) & 0x00FF) << 8) + (((uint32_t)(WRP1_Data)&0x00FF) << 16) + (((uint32_t)(~WRP1_Data) & 0x00FF) << 24)));
            buf[3] = ((uint32_t)(((uint32_t)(WRP2_Data)&0x00FF) + (((uint32_t)(~WRP2_Data) & 0x00FF) << 8) + (((uint32_t)(WRP3_Data)&0x00FF) << 16) + (((uint32_t)(~WRP3_Data) & 0x00FF) << 24)));
